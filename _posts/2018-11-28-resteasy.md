...
![]({{ site.url }}/assets/7ED254F6-227F-4591-9E0F-2F9CF63D9E4C.png)
...
![]({{ site.url }}/assets/E5DABDB0-9243-4698-81D3-E9ADAE7675AF.png)

下面是这些classes的类图：

![]({{ site.url }}/assets/Class Diagram25.png)

注意整个decorator机制是一个通用的独立设计，所以还需要在具体的provider里面使用起来才行。比如这里默认实现的`AbstractJAXBProvider`：

![]({{ site.url }}/assets/DF2F6C80-6FA7-482B-A7D2-6B1609F01826.png)

![]({{ site.url }}/assets/21943DD3-5346-4A9D-B756-5852B976A62B.png)

可以看到，decorator的具体使用入口是`DecoratorMatcher`，并且是和相关的provider具体实现搭配着来的。以上就是对decorator机制的分析。最后把测试相关的classes放出来：

![]({{ site.url }}/assets/Class Diagram25 2.png)
