...
abstract: In this article I'd like to share with you my study on JAX-RS SPEC 2.0 Section 3.7 and relative implementations in RESTEasy. (Last Updated At: Mar 13, 2017.)
---
...
The `UriInfo` interface defines the methods to retrieve the URI info, but it doesn't define how to build this info. It depends on the implementation side to build it properly. We can check the `ResteasyUriInfo` to see how does RESTEasy build the URI info.
