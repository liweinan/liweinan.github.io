...
_JAX-RS SPEC 2.0 Section 3.7_[^spec3.7] shows us how to match a URI path to actual Java method:

[^spec3.7]: [JSR-000339 The JavaTM API for RESTful Web Services](https://jcp.org/aboutJava/communityprocess/final/jsr339/index.html)
