...
![RESTEasy classes](https://github.com/liweinan/blogpicbackup/blob/master/data/spec3.7.png)
...
![org.jboss.resteasy.core.ResourceMethodRegistry.getResourceInvoker.png](https://github.com/liweinan/blogpicbackup/blob/master/data/org.jboss.resteasy.core.ResourceMethodRegistry.getResourceInvoker.png)
...
![2017-03-10-switch.png](https://github.com/liweinan/blogpicbackup/blob/master/data/2017-03-10-switch.png)
...
![org.jboss.resteasy.core.registry.RootClassNode.match.png](https://github.com/liweinan/blogpicbackup/blob/master/data/org.jboss.resteasy.core.registry.RootClassNode.match.png)
...
![org.jboss.resteasy.core.registry.ClassNode.match.png](https://github.com/liweinan/blogpicbackup/blob/master/data/org.jboss.resteasy.core.registry.ClassNode.match.png)
...
![org.jboss.resteasy.core.registry.RootNode.match.png](https://github.com/liweinan/blogpicbackup/blob/master/data/org.jboss.resteasy.core.registry.RootNode.match.png)
...
![org.jboss.resteasy.core.registry.SegmentNode.match.png](https://github.com/liweinan/blogpicbackup/blob/master/data/org.jboss.resteasy.core.registry.SegmentNode.match.png)
...
![2017-03-10-terminology.png](https://github.com/liweinan/blogpicbackup/blob/master/data/2017-03-10-terminology.png)
...
![2017-03-10-registry.png](https://github.com/liweinan/blogpicbackup/blob/master/data/2017-03-10-registry.png)
...
![2017-03-10-resource-invoker.png](https://github.com/liweinan/blogpicbackup/blob/master/data/2017-03-10-resource-invoker.png)
...
![2017-03-11-resteasy-uri-info.png](https://github.com/liweinan/blogpicbackup/blob/master/data/2017-03-11-resteasy-uri-info.png)
...
![2017-03-13-get-matched-uri.png](https://github.com/liweinan/blogpicbackup/blob/master/data/2017-03-13-get-matched-uri.png)
...
![org.jboss.resteasy.spi.ResteasyUriInfo.initialize.png](https://github.com/liweinan/blogpicbackup/blob/master/data/org.jboss.resteasy.spi.ResteasyUriInfo.initialize.png)
...
![2017-03-13-uribuilder.png](https://github.com/liweinan/blogpicbackup/blob/master/data/2017-03-13-uribuilder.png)

Here is the javadoc of the `UriBuilder`:

![2017-03-13-uribuilder-doc.png](https://github.com/liweinan/blogpicbackup/blob/master/data/2017-03-13-uribuilder-doc.png)

Here is the javadoc of the `javax.ws.rs.Path` annotation:

![2017-03-13-path.png](https://github.com/liweinan/blogpicbackup/blob/master/data/2017-03-13-path.png)

Here is the javadoc of the `Path.value()` attribute:

![2017-03-13-path.png](https://github.com/liweinan/blogpicbackup/blob/master/data/2017-03-13-path-value.png)
...
![2017-03-13-pathsegment.png](https://github.com/liweinan/blogpicbackup/blob/master/data/2017-03-13-pathsegment.png)

Here is the javadoc of `PathSegment`:

![2017-03-13-pathsegment-javadoc.png](https://github.com/liweinan/blogpicbackup/blob/master/data/2017-03-13-pathsegment-javadoc.png)

In _Section 5.3 Client Targets_ of the document, it uses the term "path segment" like this:

![2017-03-13-pathsegment-spec.png](https://github.com/liweinan/blogpicbackup/blob/master/data/2017-03-13-pathsegment-spec.png)

Here is the sequence diagram of `PathSegmentImpl.parseSegmentsOptimization()` method:

![org.jboss.resteasy.specimpl.PathSegmentImpl.parseSegmentsOptimization.png](https://github.com/liweinan/blogpicbackup/blob/master/data/org.jboss.resteasy.specimpl.PathSegmentImpl.parseSegmentsOptimization.png)

This method is used to split full URL path into path segments. The javadoc of the method is here:

![org.jboss.resteasy.specimpl.PathSegmentImpl.parseSegmentsOptimization-javadoc.png](https://github.com/liweinan/blogpicbackup/blob/master/data/org.jboss.resteasy.specimpl.PathSegmentImpl.parseSegmentsOptimization-javadoc.png)

The above method is used in `ResteasyUriInfo.processPath()` method:

![org.jboss.resteasy.spi.ResteasyUriInfo.processPath.png](https://github.com/liweinan/blogpicbackup/blob/master/data/org.jboss.resteasy.spi.ResteasyUriInfo.processPath.png)
...
![2017-03-13-whole-picture.png](https://github.com/liweinan/blogpicbackup/blob/master/data/2017-03-13-whole-picture.png)
